...
|功能|老师评定一个学生的实验成绩|
|参与者|老师|
|前置条件|查看成绩：评定成绩之前，老师需要先登录，并显示出该学生在特定学年，某一科目实验评语和实验分组评分项|
|后置条件| 评定成绩提交之后，系统自动根据成绩评分项百分比计算最终成绩|
|主事件流| 1. 查看已有的成绩 <br/> 2. 输入一个实验的各个成绩和评语  <br/> 3. 提交  <br/> 4. 系统存储实验成绩和评语<br/> 5. 系统自动计算最终成绩|
...
## 3. 界面设计
- 界面参照: https://ikowalski.github.io/is_analysis/test6/ui/评定成绩.html
