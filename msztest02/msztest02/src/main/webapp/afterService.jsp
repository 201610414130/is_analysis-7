            ...
            <tbody id="lastTr">
                ...
                <tr>
                    <td>
                        ...
                        <span>编号</span><input class="productID" name="orderproductListAfterService[0].productID" onblur="productIDCheck(this)"></input> <span id="productIDWarn0"></span>
                        <span>价格</span><input class="sellPrice" name="orderproductListAfterService[0].sellPrice" onblur="floatNumCheck(this)"></input> <span id="sellPriceWarn0"></span>
                        <span>件数</span><input class="sellBoxNum" name="orderproductListAfterService[0].sellBoxNum" onblur="intNumCheck(this)"></input> <span id="sellBoxNumWarn0"></span>
                        <span>每件几张</span><input class="BoxOwn" name="orderproductListAfterService[0].BoxOwn" onblur="intNumCheck(this)"></input> <span id="BoxOwnWarn0"></span>
                        <span>单项</span><input class="sellSingleNum" name="orderproductListAfterService[0].sellSingleNum" onblur="intNumWithZeroCheck(this)"></input> <span id="sellSingleNumWarn0"></span>
                        <span>备注</span><input class="remark" name="serviceListAfterService[0].remark" onblur="remarkCheck(this)"></input> <span id="remarkWarn0"></span>
